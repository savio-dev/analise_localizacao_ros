...
class MonteCarloLocalizer(Node):
    ...
    def __init__(self):
        ...
        self._atual_position_pub = self.create_publisher(PoseStamped, '/position_atual', 10)
        ...
        package_dir = get_package_share_directory('ros_analise')
        ...
        self._map = Map('resource/map_rats_life.yaml', self.get_logger())
    ...
    def odometry_callback(self, msg: Odometry):
        ...
        self._publish_position_atual(self._current_pose, stamp)
    ...
    def _initialize_pose(self):
        position = Point(x=0.0,
                         y=-0.05,
                         z=0.0)
        orientation = Quaternion(x=0.0, y=0.0, z=1.0, w=3.14)
    ...
    def _publish_position_atual(self, pose_atual: Pose, stamp):
        self._posicao.header.frame_id = 'odom'
        self._posicao.header.stamp = stamp
        self._posicao.pose = pose_atual
        self._atual_position_pub.publish(self._posicao)
